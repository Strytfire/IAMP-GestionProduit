...
Namespace Global.MarchandPPE
    Public Class GestionCommande
        ...
        End Function
        Public Shared Function DGCommandeStat()
            Return GestionBDD.Executer_Requete_Select(“SELECT commande.idCommande as Numero_Commande, DateCommande, CONCAT( NomClient,' ', PrenomClient) AS Patronyme, SUM(QuantiteCom * PrixHTProduit) + (SUM(QuantiteCom * PrixHTProduit) * 0.2) AS MontantTTC FROM commande, client, lignedecommande, produit WHERE commande.idCli = client.idClient AND commande.idcommande = lignedecommande.idCommande AND lignedecommande.idProduit = produit.idProduit GROUP BY commande.idCommande”)
        End Function
        Public Shared Function DGCommandeStatCNP()
            Return GestionBDD.Executer_Requete_Select(“SELECT * FROM commande WHERE CommandeReglee = 1;”)
        End Function
